...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference("Reference.count") do
      post references_url, params: { reference: { references_text: @reference.references_text } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { references_text: @reference.references_text } }
